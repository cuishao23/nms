<template>
  <div class="tradition-meeting-detail">
    ...
    <div v-if="MeetingDetail === 'LiveStreaming'" class = "meetingDetailInfo">
  ...
  export default {
    ...
    methods: {
      ...
      gotoCascadeMeetingDetail: function(data) {
        console.log(data)
        this.$router.push({name: 'realtimemultipointmeeting',
